...
public:
	...
	BYTE* createTerrain(Bitmap * terrainBMP, BYTE* heightMapBuffer, uint32_t &seaLevel, double landPercentage);
	...
	void prettyProvinces(Bitmap * provinceBMP, uint32_t minProvSize, uint32_t updateThreshold);
